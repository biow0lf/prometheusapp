    ...
    ActiveRecord::Base.transaction do
      ...
      file.each_line do |line|
        ...
        for i in 1..line.split.count-1
          if i == 1
            Team.create :name => team_name, :login => line.split[i], :leader => 'yes', :branch => branch, :vendor => vendor
          else
            Team.create :name => team_name, :login => line.split[i], :leader => 'no', :branch => branch, :vendor => vendor
          end
        end
      end
    end
